...
public class TestCtmPostPiDataStep {
    ...
    public void buildWithEmptyServerUrlMustFail() throws Exception {
        ...
        p.setDefinition(new CpsFlowDefinition(
                "ctmPostPiData serverUrl: '', key: 'key1234', value: 'val12324', markUnstable: true"
        ));
    ...
    public void buildWithEmptyKeyMustFail() throws Exception {
        ...
        p.setDefinition(new CpsFlowDefinition(
                "ctmPostPiData serverUrl: 'http://server.url', key: '', value: 'val12324', markUnstable: true"
        ));
        WorkflowRun b1 = p.scheduleBuild2(0).waitForStart();
        jenkins.assertBuildStatus(Result.UNSTABLE, jenkins.waitForCompletion(b1));
    ...
    public void buildWithEmptyValueMustFail() throws Exception {
        ...
        p.setDefinition(new CpsFlowDefinition(
                "ctmPostPiData serverUrl: 'http://server.url', key: 'key1234', value: '', markUnstable: true"
        ));
        WorkflowRun b1 = p.scheduleBuild2(0).waitForStart();
        jenkins.assertBuildStatus(Result.UNSTABLE, jenkins.waitForCompletion(b1));
